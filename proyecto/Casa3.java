...
/**
 * Este es el escenario del tercer nivel, ademas de mostrar a las personas que debes evitar.
 * @author (Maria Gpe. Velazquez Martinez y Cristobal Zavala Cano) 
 * @version (a version number or a date)
 */
public class Casa3 extends World
{
    ...
    public void creaPeople()
    {
        ...
        for(int i = 0; i < 9; i++ ){
            ...
            if(i==2){
                ...
                addObject(ad1,x,238);   //creando adulto en el piso 2
                addObject(ad2,x,355);   //creando adulto en el piso 1
                addObject(gu4,280,480); //creando guardia en el piso 0
            }
            ...
            if(i==7){
                addObject(pe7,x,480);   //creando en el piso 1
            }
            if(i==8){
                addObject(pe8,x,115);   //creando en el piso 3
            }
       }
    }
